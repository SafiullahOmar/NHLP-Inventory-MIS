...
function GetRequestedDetail() {
    $.ajax({
        type: "POST",
        url: "IssueInvStoreC.aspx/GetStoreReqDetail",
        data: '',
        dataType: "json",
...
function showMDReqItemsDetail(obj) {
    ...
    $.ajax({
        type: "POST",
        url: "IssueInvStoreC.aspx/GetReqItemDetail",
...
function getSubClass() {
    $.ajax({
        type: "POST",
        url: "IssueInvStoreC.aspx/GetSubClass",
        data: '',
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        success: function (data) {
...
function GetIssueItems(obj) {
    $.ajax({
        type: "POST",
        url: "IssueInvStoreC.aspx/GetStoreItems",
...
function IssueItemsList() {
    ...
    $.ajax({
        type: "POST",
        url: "IssueInvStoreC.aspx/SaveFormDetail",
        data: jsonObject,
        dataType: "json",
        async: false,
        contentType: "application/json; charset=utf-8",
...
function GetItemNumberInStock(obj) {
    $.ajax({
        type: "POST",
        url: "IssueInvStoreC.aspx/GeItemsNumbersInStock",
...
function Reject() {
    ...
    $.ajax({
        type: "POST",
        url: "IssueInvStoreC.aspx/RejectFormDetail",
        data: jsonObject,
        dataType: "json",
        async: false,
        contentType: "application/json; charset=utf-8",
