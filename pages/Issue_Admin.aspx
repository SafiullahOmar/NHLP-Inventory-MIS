<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="Issue_Admin.aspx.cs" Inherits="pages_ReqApproval" %>

<asp:Content ID="Content1" ContentPlaceHolderID="pageTopic" runat="Server">
     ADMIN GOODS ISSUE FORM
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="pageTopicDetail" runat="Server">
    The below form is going to issue items in the system on the base of those requisition forms which were processed and approved by thier relevant supervisors .Fill the form according to the requirments.
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="pageBody" runat="Server">
    <script src="../Script/Issue_admin.js"></script>
                    ...
                    <div class="card-block">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-4 text-md-center">
                                ...
                                <h6 class="far text-md-center">Admin Section <code>Office Supply Issue form</code>  </h6>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div id="DivRightNewIssueDetails">
                                    <div class="row">
                                        <div class="form-group col-md-5">
                                            <label class="col-md-5 label-control" for="ddlItemClass">I/Sub Class</label>
                                            <div class="col-md-7">
                                                <select class="form-control" id="ddlItemSubClass"></select>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-7">
                                            <label class="col-md-2 label-control" for="ddlItem">Item</label>
                                            <div class="col-md-10">
    ...
    <input type="hidden" id="hdnDeptId" /> <input type="hidden" id="hdnProvId" /><input type="hidden" id="hdnReqId" />
</asp:Content>
