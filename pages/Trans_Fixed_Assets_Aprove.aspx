<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="Trans_Fixed_Assets_Aprove.aspx.cs" Inherits="pages_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="pageTopic" runat="Server">
    TRANSFERED Fixed Assets APPROVAL
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="pageTopicDetail" runat="Server">
     The below form is going to approve the items which were transfered to your regions.<code><strong> Please be noted once you approved then your approval won't be rollbacked again.</strong></code> 
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="pageBody" runat="Server">

    <script src="../Script/Trans_Fixed_Assets_Approve.js"></script>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="horz-layout-card-center"> Transfered Asset Descriptions</h4>
