<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="IssueInvStoreC.aspx.cs" Inherits="pages_ReqApproval" %>

<asp:Content ID="Content1" ContentPlaceHolderID="pageTopic" runat="Server">
     WareHouse/Store(C) Items ISSUE FORM
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="pageBody" runat="Server">
    <script src="../Script/IssueINVStoreC.js"></script>
    <div class="row  bg-warning bg-darken-4  ">
        <div class="col-md-12  bg-facebook bg-darken-1">
            <div class="card">
                <div class="card-body">
                    <div class="card-block">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-4 text-md-center">
                                ...
                                <h6 class="far text-md-center">Ware House Section <code>Items Issue form</code>  </h6>
                            </div>
                            <div class="col-md-4">
