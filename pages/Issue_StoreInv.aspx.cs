...
public partial class pages_ReqApproval : System.Web.UI.Page
{
    ...
    [WebMethod]
    [System.Web.Script.Services.ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static Items GetStoreItems(string Code)
    {
        Items p = new Items();
        string constr = System.Web.Configuration.WebConfigurationManager.ConnectionStrings["INVCon"].ConnectionString;
        SqlConnection con = new SqlConnection(constr);
    ...
    public static string GeItemsNumbersInStock(string ItmID)
    {
        ...
        SqlCommand com = con.CreateCommand();
        com.CommandType = CommandType.StoredProcedure;
        com.CommandText = "spPageIssueAdmin_GetStoredItemCount";
    ...
    public static void SaveFormDetail(IssuedItems formDetails)
    {
        ...
        try
        {
            ...
            if (formDetails.IList.Count > 0)
            {
                ...
                {
                    query += @"  INSERT INTO [dbo].[tblINV_IISUVD] ([ISSUID],[It_Code],[It_ID] ,[QU]  ,[UserId] ,[InsertedDate])
                                VALUES (tey," + itm.Code + ",N'" + itm.ID + "'," + itm.Quantity + ",'" + usr.ProviderUserKey.ToString() + "',N'" + DateTime.Now.ToString() + "')";
                ...
                if (query.Length > 0)
                {
                    ...
                    string ID = dbT.ExecuteTransStoreProcedureReturn("spPageAdminIssueItemV_Save", p, true, "@ID");
                    foreach (Items itm in formDetails.IList)
                    {
                        ...
                        pRD[4] = new SqlParameter("@ProvId", SqlDbType.Int) { Value = OCM_UserInfo.GetUserOfficeLocation() };
                        pRD[5] = new SqlParameter("@UpdateType", SqlDbType.Char) { Value = "I" };
                        ...
                        pRD[7] = new SqlParameter("@InsertedDate", SqlDbType.NVarChar) { Value = formDetails.IS_D };
