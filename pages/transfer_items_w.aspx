<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="transfer_items_w.aspx.cs" Inherits="pages_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="pageTopicDetail" runat="Server">
    The below form is going to record the items which are transfered from one regions to other regions and also the search result data list gives the facility to manipulate the transfer list items according to user right.
</asp:Content>  
<asp:Content ID="Content3" ContentPlaceHolderID="pageBody" runat="Server">

    <script src="../Script/transfer_items_w.js"></script>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="horz-layout-card-center"><a id="lnkSearch" class="btn btn-social-icon mr-1 mb-1 btn-outline-dropbox" href="#"><span class="icon-search font-medium-4"></span></a>&nbsp Transfer Goods Details</h4>
                    ...
                    <div class="card-body collapse in">
                        <div class="card-block">
                            <div class="card-text">
                                <p>Add <code> form details </code>to the form for their groups.</p>
                            </div>
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row mt-2">
                                        <%--<div class="form-group col-md-5">
                                            <label class="col-md-6 label-control" for="txtBrcd">Barcode #</label>
                                            <div class="col-md-6">
                                                <input id="txtBrcd" class="form-control" placeholder="Barcode #" type="text">
                                            </div>
                                        </div>--%>
                                        <div class="form-group col-md-12">
                                            <label class="col-md-2 label-control" for="txtItemInfo">Item Detail</label>
                                            <div class="col-md-10">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="col-md-10">
                                                <input id="txtItemQuantity" class="form-control ml-2 width-95-per" placeholder="Quantity" type="text">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <p>Transfer Goods list .<code> You can Manipulate the list </code></p>
