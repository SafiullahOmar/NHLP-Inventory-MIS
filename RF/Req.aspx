<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="Req.aspx.cs" Inherits="pages_Req" %>

<asp:Content ID="Content1" Visible="false" ContentPlaceHolderID="pageTopic" runat="Server">
   OFFICE USE ITEMS REQUISITION FORM 
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="pageBody" runat="Server">
    <script src="../Script/StoreReq.js"></script>
                    ...
                    <div class="card-block">
                        ...
                        <div class="row blue">
                            ...
                            <div class="col-md-4 text-md-center">
                                ...
                                <h6 class="far text-md-center"> Requisition Form (<code> Office Use Items</code>)</h6>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p>
                                    <a id="lnkShowItemInsertModal" data-backdrop="false" class="btn btn-social-icon mr-1 mb-1 btn-outline-dropbox primary" href="#"><span class="icon-plus-circle font-medium-4"></span></a>
                                    <a id="lnkShowItemRemove" class="btn btn-social-icon mr-1 mb-1 btn-outline-dropbox primary" href="#"><span class="icon-delete font-medium-4"></span></a>
                                </p>
    ...
    <div class="modal fade text-xs-left" id="MDItemInsert"  role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-primary bg-lighten-3 white">
