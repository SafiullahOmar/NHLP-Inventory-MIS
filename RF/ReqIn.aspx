<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="ReqIn.aspx.cs" Inherits="pages_Req" %>

<asp:Content ID="Content1" Visible="false" ContentPlaceHolderID="pageTopic" runat="Server">
    WAREHOUSE TOOLS  REQUISITION FORM
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="pageBody" runat="Server">
    <script src="../Script/StoreReqIn.js"></script>
    <div class="row ">
                    ...
                    <div class="card-block">
                        ...
                        <div class="row teal">
                            ...
                            <div class="col-md-4 text-md-center">
                                ...
                                <h6 class="far text-md-center">Store Requisition Form<br />
                                    (<code> WAREHOUSE Tools Items</code>)</h6>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row">
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="form-group col-md-12 rtl">
                                                ...
                                                <div class="col-md-9">
                                                    <select class="select2-size-xs form-control" id="ddlProvince"></select>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-12 rtl">
                                                <label class="col-md-3 label-control" for="ddlDepartment">Department</label>
                                                <div class="col-md-9">
                                                    <select class="form-control select2-size-xs " id="ddlDepartment"></select>
                                                </div>
                                            </div>
                            ...
                            <div  class="col-md-6 offset-md-6 subcomponent" >
                                <div class="form form-horizontal">
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="form-group col-md-12 rtl">
                                                <label class="col-md-3 label-control" for="ddlSubComp">S/Component</label>
                                                <div class="col-md-9">
                                                    <select class="form-control select2-size-xs " id="ddlSubComp"></select>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p>
                                    <a id="lnkShowItemInsertModal" data-backdrop="false" class="btn btn-social-icon mr-1 mb-1 btn-outline-dropbox teal" href="#"><span class="icon-plus-circle font-medium-4"></span></a>
                                    <a id="lnkShowItemRemove" class="btn btn-social-icon mr-1 mb-1 btn-outline-dropbox teal" href="#"><span class="icon-delete font-medium-4"></span></a>
                                </p>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="card-text col-md-7 label-control">
                                    <hr />
                                    <p><b>*** :: Please Upload beneficiaries list <code>(Required)</code></b></p>
                                </div>
                                <div class="col-md-5">
                                    <hr />
    ...
    <div class="modal fade text-xs-left" id="MDItemInsert" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-teal white">
                        ...
                        <div class="form-body">
                            <div class="row far text-md-center">
                                ...
                                <div class="form-group col-md-12 ">
                                    ...
                                    <div class="col-md-9">
                                        <select id="ddlUnit" class="form-control select2-size-xs"></select>
                                    </div>
                                </div>
                                <div class="form-group col-md-12 ">
